...
{
    /// <summary>
    /// Helper class for creating SkyDriveNet RestSharp Requests
    /// </summary>
    public class RequestHelper
    {
        public RestRequest CreateFolderRequest(string folderId)
        {
            var request = new RestRequest(Method.GET);
            request.Resource = "/{folder}";
            request.AddParameter("folder", SkyDriveHelper.GetFolderId(folderId), ParameterType.UrlSegment);

            return request;
        }

        public RestRequest CreateFolderFilesRequest(string folderId)
        {
            var request = new RestRequest(Method.GET);
            request.Resource = "/{folder}/files";
            request.AddParameter("folder", SkyDriveHelper.GetFolderId(folderId), ParameterType.UrlSegment);
